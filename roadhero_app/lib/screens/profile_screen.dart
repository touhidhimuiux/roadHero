                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: const NetworkImage('https://cdn-icons-png.flaticon.com/512/3135/3135715.png'), // Placeholder Avatar
                    ),
                  ),
                  const SizedBox(height: 15),
                  const Text('Asif Iqbal Emon', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                  const SizedBox(height: 5),
                  const Text('asif.emon04@northsouth.edu', style: TextStyle(color: Colors.white70)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(height: 40, width: 1, color: Colors.white30), // Divider
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildMenuOption(Icons.notifications_outlined, 'Notification Settings'),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        // Normally this would navigate to the Login Screen
    ...
    return Container(
      ...
      child: ListTile(
        leading: Container(
          ...
          decoration: BoxDecoration(color: const Color(0xFF1E60D1).withOpacity(0.1), shape: BoxShape.circle),
